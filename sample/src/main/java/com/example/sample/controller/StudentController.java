...
public class StudentController {
  ...
  @PutMapping("/update")
  public Student updateStudent(@RequestBody Student r)
  {
	  return studService.updateStudent(r);
  }
  ...
  @GetMapping("/fetch/{id}")
  public Optional<Student> findByIdStudent(@PathVariable int id)
  {
	  return studService.findByIdStudent(id);
  }
 }
